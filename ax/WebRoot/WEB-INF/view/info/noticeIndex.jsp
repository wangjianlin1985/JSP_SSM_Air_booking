...
<table  id="dg" class="easyui-datagrid" fitColumns="true"
        ...
        <thead>
            	<tr>
                	...
                	<th field="istop" width="60" align="center" formatter="formatTOP">是否置顶</th>
            	</tr>
        </thead>
        <script>
        	...
        	function formatTOP(value,row,index){
        		if(value=="1"){
        			return "是";
         		} else {
         			return "否";
...
<div id="tb" >
	...
	<div>
		<privilege:operation operationId="4ff969b8052349728384f584a44276" clazz="easyui-linkbutton" onClick="openNoticeAddDialog()" name="发布"  iconCls="icon-add" ></privilege:operation>
		<privilege:operation operationId="ebe18da614054a958c6307556b0364" clazz="easyui-linkbutton" onClick="openNoticeUpdateDialog()" name="修改"  iconCls="icon-edit" ></privilege:operation>
		<privilege:operation operationId="0a384065455d408b98790f2f7abb64" clazz="easyui-linkbutton" onClick="deleteNotice()" name="删除"  iconCls="icon-remove" ></privilege:operation>
	</div>
	<div class="updownInterval"> </div>
	<div>
